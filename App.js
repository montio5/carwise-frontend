...
const CarStackScreens = () => (
  ...
  options={({ route,navigation }) => ({
    title: route.params.customField?.name || strings.mainStack.customField,
...
/>
      <CarStack.Screen
        ...
        component={CarScreen}
        options={({ route, navigation }) => ({
          title: route.params?.car?.name || strings.mainStack.car,
...
<CarStack.Screen
  ...
  options={({ route }) => ({
    title: route.params?.car?.name || strings.mainStack.addCar,
  })}
/>
<CarStack.Screen
...
const MainStackScreens = () => (
  ...
  >
    ...
    <MainStack.Screen
      ...
      options={{ 
        tabBarLabel: strings.mainStack.notification
